...
use crate::{asset_loader::SceneAssets, collision_detection::{self, CollisionDamage}, health::Health, movement, schedule::InGameSet};
...
fn spawn_asteroid(mut commands: Commands, mut spawn_timer: ResMut<SpawnTimer>, time: Res<Time>, scene_assets: Res<SceneAssets>) {
  ...
  commands.spawn((
    ...
    velocity: movement::Velocity::new(velocity),
    accelaration: movement::Acceleration::new(acceleration),
    collider: collision_detection::Collider::new(RADIUS),
    model: SceneBundle {
